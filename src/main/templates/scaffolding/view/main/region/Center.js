 ...
 */
Ext.define('appMis.view.main.region.${className}Center', {
	extend : 'Ext.tab.Panel',
	xtype: '${propertyName}maincenter',
	border: false,
	id: '${propertyName}contentpanel',
	defaults: {
		autoScroll: true,
		bodyPadding: 5
	},
	closable : true,
	header: false,
	//items:Ext.create('appMis.view.${propertyName}.${className}mainpageViewport'),//会发生死机
	...
	initComponent : function() {
			//this.items=Ext.create('appMis.view.${propertyName}.${className}MainpageViewport')
