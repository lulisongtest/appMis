...
Ext.define('appMis.store.ProcessHistoryTaskStore',
    {
        ...
        constructor: function (cfg) {
            ...
            me.callParent([
                Ext.apply({
                    ...
                    storeId: 'ProcessHistoryTaskStore',
                    autoLoad: true,

                    proxy: {
                        type: 'ajax',
                        api: {
                            read: '/appMis/processTask/readProcessHistoryTask'
                        },
                        noCache: false,
                        actionMethods: {
                            read: 'POST'
                        ...
                        reader: {
                            rootProperty: 'processHistoryTasks',
