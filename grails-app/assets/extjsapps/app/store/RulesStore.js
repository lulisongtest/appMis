...
Ext.define('appMis.store.RulesStore', { extend: 'Ext.data.Store',singleton: false,requires: ['appMis.model.RulesModel','Ext.grid.*','Ext.toolbar.Paging','Ext.data.*'],
pageSize:25,
 remoteSort: true,
...
proxy: {
   type: 'ajax',
   api: {
   read :'/appMis/rules/readRules?currentRulesDate=' + new Date().pattern("yyyy-MM-dd")
},
noCache: false,
actionMethods: {
    read:'POST'
