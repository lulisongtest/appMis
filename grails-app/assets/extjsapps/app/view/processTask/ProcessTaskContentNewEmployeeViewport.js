...
var newvalue1
var newvalue2
Ext.define('appMis.view.processTask.ProcessTaskContentNewEmployeeViewport', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.processTaskContentNewEmployeeViewport',
    defaults: {
        autoScroll: true,
        bodyPadding: 0,
        border: 0,
            ...
            items: [
                ...
                },
                {
                    ...
                    handler : function(){
                       ...
                       //从form中获取数据
                        var values=Ext.getCmp('newEmployeeform').getValues()
