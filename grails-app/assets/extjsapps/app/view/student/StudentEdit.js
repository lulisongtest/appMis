...
Ext.define('appMis.view.student.StudentEdit' ,{
                                ...
                                listeners: {
                                    blur: function () {//渲染完成后，初始时会激活一次change
                                        ...
                                        if(idNumber.length==18){
                                            Ext.getCmp('birthDateedit').setValue(""+idNumber.substr(6,4)+"-"+idNumber.substr(10,2)+"-"+idNumber.substr(12,2))
                                        }else{
                                            Ext.getCmp('birthDateedit').setValue("19"+idNumber.substr(6,2)+"-"+idNumber.substr(8,2)+"-"+idNumber.substr(10,2))
                                        }
                                    }
                                }
                            }, {
                ...
                items:[
                    {
                        xtype: 'image',
                        id:"photoEdit",
                        src:'/appMis/student/displayPhoto?username=' + selectUsername+'&time=' +Math.random(),
                        columnWidth:1,
                        autoShow : true,
                        padding:'10 20 10 20',
                        height: 210
