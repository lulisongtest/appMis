Ext.define('appMis.view.requestmap.RequestmapEdit' ,{
    extend: 'Ext.window.Window',
    alias : 'widget.requestmapedit',
    width:480,
    title : '修改requestmap信息',
    layout: 'fit',
    autoShow: true,
        ...
        this.items = [
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        listeners:{
                            focus:function(){
                                if(Ext.getCmp("requestmaproleListedit").getValue()!=null){
                                    // ""+是强制转换为字符串后再转换为数组，方便选择或取消选择!!
                                    Ext.getCmp("requestmaproleListedit").setValue((""+Ext.getCmp("requestmaproleListedit").getValue()).split(","))
                                    setENTERflag(1)
                                }
                            },
                            change:function(){
                                setENTERflag(0)
                                if((Ext.getCmp("requestmaproleListedit").getValue()==null)||(Ext.getCmp("requestmaproleListedit").getValue()==""))Ext.getCmp("requestmaproleListedit").setValue("普通用户")
