Ext.define('appMis.view.user.SelectDepartment', {
    extend: 'Ext.window.Window',
    xtype: 'selectDepartment',
   // id: 'selectDepartment',
    width: 570,
    height: 500,
    title: '选择部门信息',
    ...
    initComponent : function() {
        ...
        this.items={
                ...
                root:  Ext.getCmp("viewModelDataRoot").getViewModel().get('systemTreeMenu'),//viewModelDataRoot在App.js中。很奇怪，按钮菜单要加上[],而树则不能加[]
                listeners: {
