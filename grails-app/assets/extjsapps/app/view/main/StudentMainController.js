...
Ext.define('appMis.view.main.StudentMainController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.studentmain',
    requires: [
    ],
    init: function () {
        ...
        this.control({
            'studentmain > studentmainleft > studenttreemainmenu': {
 ...
 //单击单位目录树后
    itemclick1: function (selModel, record) {
       if ((loginUserRole == '单位管理员')||(loginUserRole == '单位审核人')){
            ...
            Ext.getCmp("studentmainleft").hide();
        }else{
        ...
        if (!panel) {
           ...
           // departmentDetail=record.get('text');
            ...
            panel = Ext.create('appMis.view.student.StudentViewport', {
