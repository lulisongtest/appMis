 ...
 */
Ext.define('appMis.view.main.region.TeacherCenter', {
	extend : 'Ext.tab.Panel',
	xtype: 'teachermaincenter',
	border: false,
	id: 'teachercontentpanel',
	defaults: {
		autoScroll: true,
		bodyPadding: 5
	},
	closable : true,
	header: false,
	//items:Ext.create('appMis.view.teacher.TeachermainpageViewport'),//会发生死机
	...
	initComponent : function() {
			//this.items=Ext.create('appMis.view.teacher.TeacherMainpageViewport')
