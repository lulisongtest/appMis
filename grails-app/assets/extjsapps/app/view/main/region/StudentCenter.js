 ...
 */
Ext.define('appMis.view.main.region.StudentCenter', {
	extend : 'Ext.tab.Panel',
	xtype: 'studentmaincenter',
	border: false,
	id: 'studentcontentpanel',
	defaults: {
		autoScroll: true,
		bodyPadding: 5
	},
	closable : true,
	header: false,
	//items:Ext.create('appMis.view.student.StudentmainpageViewport'),//会发生死机
	...
	initComponent : function() {
			//this.items=Ext.create('appMis.view.student.StudentMainpageViewport')
