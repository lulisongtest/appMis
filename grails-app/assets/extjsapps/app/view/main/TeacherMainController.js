...
Ext.define('appMis.view.main.TeacherMainController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.teachermain',
    requires: [
    ],
    init: function () {
        ...
        this.control({
            'teachermain > teachermainleft > teachertreemainmenu': {
    ...
    itemclick1: function (selModel, record) {
       if ((loginUserRole == '单位管理员')||(loginUserRole == '单位审核人')){
            ...
            Ext.getCmp("teachermainleft").hide();
        }else{
        ...
        if (!panel) {
            ...
            panel = Ext.create('appMis.view.teacher.TeacherViewport', {
