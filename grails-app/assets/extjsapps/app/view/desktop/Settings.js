...
Ext.define('appMis.view.desktop.Settings', {
    ...
    uses: [
        ...
        'appMis.view.desktop.model.Wallpaper'
    ],
    ...
    initComponent: function () {
        ...
        me.buttons = [
            ...
            { text: '放弃', handler: me.close, scope: me }
        ];
    ...
    createTree : function() {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: 'appMis.view.desktop.model.Wallpaper',
                root: {
                    text:'Wallpaper',
                    expanded: true,
                    children:[
    ...
    onSelect: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = 'build/development/appMis/resources/images/wallpapers/' + record.data.img;
        } else {
