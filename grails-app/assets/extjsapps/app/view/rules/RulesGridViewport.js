...
Ext.define('appMis.view.rules.RulesGridViewport', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.rulesgridviewport',
    ...
    initComponent: function () {
        ...
        //var readAuth=Ext.getCmp('rulesReadAuth').isHidden()//true为普通用户，只能查看数据，不能修改任何数据。
        var readAuth =  ((Roleflag!="单位管理员")&&(Roleflag!="管理员"))
       // this.store = 'RulesStore';
                ...
                '-', '每页数据', {
                    ...
                    listeners: {
                        ...
                        change: function (combo) {
                            ...
                            var newvalue1 = (new Date(Ext.getCmp('currentRulesDate').getValue()).pattern("yyyy-MM-dd"));
                            panelStore.proxy.api.read = '/appMis/rules/readRules?currentRulesDate=' + newvalue1;
