...
class SecurityUiTagLib  {
    ...
    def formContainer = { attrs, body ->
        ...
        else if (type == 'forgotPassword' ||type == 'resetPasswordx' || type == 'register' || type == 'resetPassword' || type == 'securityQuestions') {
...
// TODO encodeAsHTML
     ...
     */
    def showFlash = { attrs ->
        String message = flash.remove('message')//赋值后，再清除
        ...
        writeDocumentReady out, """\t\$.jGrowl('<span class="$clazz" id="xx">$text</span>', { life: 10000 });"""
    }
	...
	\$('#$elementId').bind('click', function() {
          // alert("0000formCheckCode()==="+formCheckCode()+"-----${formName}===="+${formName}) 
       if("${formName}"=="loginForm"){
          // alert("1111formCheckCode()==="+formCheckCode()) 
           if(formCheckCode()) document.forms.${formName}.submit();
       }else{
          //alert("2222formCheckCode()==="+formCheckCode()) 
