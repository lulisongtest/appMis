 ...
 */
class CreateAddjs {
    def createAddjs(String tablename){
        ...
        try {
            ...
            sb.append("""
Ext.define('salaryMis.view."""+tablename+"""."""+initcap2(tablename)+"""Add' ,{
    extend: 'Ext.window.Window',
    alias : 'widget."""+tablename+"""add',
    title : '增加"""+list[0].tableName+"""信息',
    width:1100,
    x:260,
    y: 190,
    //layout: 'fit',
    ...
    initComponent: function() {
        ...
        this.callParent(arguments);
            ...
            """)
            FileWriter fw = new FileWriter("D:\\myPro\\salaryMis\\grails-app\\assets\\extjsapps\\app\\view\\"+tablename+"\\"+initcap2(tablename)+"Add.js");
