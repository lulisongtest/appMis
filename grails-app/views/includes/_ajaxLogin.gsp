<g:set var='securityConfig' value='${applicationContext.springSecurityService.securityConfig}'/>
					...
					<div class="s2ui_center">
						<div id="loginFormContainer" style="display:none" title="${message(code:'spring.security.ui.login.signin')}">
							<form action="${request.contextPath}${securityConfig.apf.filterProcessesUrl}" method="post" id="loginForm" name="loginForm" autocomplete="off"  onsubmit="return formCheckCode();">
